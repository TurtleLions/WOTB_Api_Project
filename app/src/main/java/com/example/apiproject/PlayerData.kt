...
@Parcelize
data class PlayerData(val status: String?, val data: Map<Int, Statistics>, val account_id: Int, val nickname: String):Parcelable{
    @Parcelize
    data class Statistics(val all: List<All>):Parcelable{
        @Parcelize
        data class All(
            val spotted: Int,
